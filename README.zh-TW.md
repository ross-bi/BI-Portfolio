...
擁有 20 年運營實務經驗的 BI & 運營協調員，專長涵蓋船務操作、進出口單證處理、倉庫存貨追蹤
及業務流程協調，現正轉型至 Operations Analyst 及 BI Analyst 職位。

豐富的運營背景為我的數據工作帶來實質優勢：我了解庫存如何在供應鏈中流動、貨運單證如何對應
成本中心，以及倉庫 KPI（存貨周轉率、呆滯庫存、補貨點）背後所反映的真實業務決策——而不僅僅
是 Dashboard 上的數字。

我使用 SQL、PostgreSQL、Power BI、dbt 及 BigQuery 構建端到端的 BI Portfolio 項目，分析
銷售業績、客戶旅程、廣告投資回報及庫存運營。我的目標是將業務領域知識與數據工程相結合——
將雜亂的運營數據轉化為清晰、可付諸行動的業務洞察。
