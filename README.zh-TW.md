...
我是一名營運專業人士，具備多年在船務協調、進出口文件、倉務支援、庫存追蹤及業務流程協調方面的實務經驗。自 2025 年轉任 BI & Operations Coordinator 以來，我一直逐步轉向 Business Intelligence 與 Operations Analyst 相關職位。

我的營運背景讓我在數據工作上具備實際優勢：我了解庫存如何在供應鏈中流動，了解貨運文件如何對應到成本中心，也理解倉庫 KPI（如庫存周轉、呆滯庫存、補貨點）如何反映真實的業務決策，而不只是儀表板上的數字。

我使用 SQL、PostgreSQL、Power BI、dbt 和 BigQuery 建立端到端 BI 作品集專案，分析銷售表現、客戶旅程、廣告投資回報，以及庫存營運。我的目標是結合業務領域知識與數據工程能力，將雜亂的營運數據整理成清晰、可執行的業務洞察，支援持份者作出更有效的決策。
