...
商业智能与营运协调员，正转型为 营运 / 物流分析师 角色。
我利用 SQL、PostgreSQL、Power BI、dbt 和 BigQuery 建立作品集项目，分析销售、顾客旅程、营运流程以及库存绩效。
凭借在航运、进出口文件、仓库追踪、销售报告及业务流程支持方面的实务经验，我专注于将营运数据转化为清晰的商业洞察与实用的仪表板。
